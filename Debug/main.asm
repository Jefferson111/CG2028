 ...
 103 0042 FFF7FEFF 		bl	scanf
  21:../src/main.c **** 
  22:../src/main.c **** //  ARM ASM & Integer version
  23:../src/main.c ****     printf("ARM ASM & Integer version:\n");
 104              		.loc 1 23 0
 ...
 108 0050 FFF7FEFF 		bl	printf
  24:../src/main.c ****     xsoli = optimize((int) x * 100, a, 100 * b, &iter);
 109              		.loc 1 24 0
 ...
 124 007e FB61     		str	r3, [r7, #28]
  25:../src/main.c ****     xsol = xsoli / 100.0;
 125              		.loc 1 25 0
 ...
 151 00c2 FFF7FEFF 		bl	printf
  27:../src/main.c ****     printf("Number of iterations : %d\n\n", iter);
 152              		.loc 1 27 0
 ...
 207 0144 7B60     		str	r3, [r7, #4]	@ float
  40:../src/main.c **** 
  41:../src/main.c ****     	printf("x: %f, fp: %f, change: %f\n", x, fp, change);
 208              		.loc 1 41 0
 ...
 229 017c FFF7FEFF 		bl	printf
  42:../src/main.c ****     	if (x==xprev) break;
 230              		.loc 1 42 0
 ...
 243              	.L4:
  44:../src/main.c **** 
  45:../src/main.c ****     // Enter an infinite loop, just incrementing a counter
  46:../src/main.c **** 	// This is for convenience to allow registers, variables and memory locations to be inspected at t
  47:../src/main.c **** 	volatile static int loop = 0;
  48:../src/main.c **** 	while (1) {
  49:../src/main.c **** 		loop++;
 244              		.loc 1 49 0 discriminator 1
 ...
 251 01aa 1A60     		str	r2, [r3, #0]
  50:../src/main.c **** 	}
 252              		.loc 1 50 0 discriminator 1
 253 01ac F2E7     		b	.L4
 254              	.L8:
...
DEFINED SYMBOLS
                            *ABS*:00000000 main.c
C:\Users\jeffe\AppData\Local\Temp\cceufyjo.s:19     .rodata:00000000 $d
C:\Users\jeffe\AppData\Local\Temp\cceufyjo.s:20     .rodata:00000000 .LC0
C:\Users\jeffe\AppData\Local\Temp\cceufyjo.s:24     .rodata:00000038 .LC1
C:\Users\jeffe\AppData\Local\Temp\cceufyjo.s:27     .rodata:0000003c .LC2
C:\Users\jeffe\AppData\Local\Temp\cceufyjo.s:34     .rodata:00000058 .LC3
C:\Users\jeffe\AppData\Local\Temp\cceufyjo.s:38     .rodata:00000068 .LC4
C:\Users\jeffe\AppData\Local\Temp\cceufyjo.s:41     .rodata:00000084 .LC5
C:\Users\jeffe\AppData\Local\Temp\cceufyjo.s:47     .rodata:000000a4 .LC6
C:\Users\jeffe\AppData\Local\Temp\cceufyjo.s:51     .text.main:00000000 $t
C:\Users\jeffe\AppData\Local\Temp\cceufyjo.s:56     .text.main:00000000 main
C:\Users\jeffe\AppData\Local\Temp\cceufyjo.s:263    .bss:00000000 loop.3827
C:\Users\jeffe\AppData\Local\Temp\cceufyjo.s:257    .text.main:000001b0 $d
C:\Users\jeffe\AppData\Local\Temp\cceufyjo.s:262    .bss:00000000 $d
