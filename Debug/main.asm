  ...
  58              		.file 1 "../src/main.c"
   ...
   8:../src/main.c ****  * Alex Teo Kang Jie, A0180338E
   9:../src/main.c ****  * Chu Jui Hung @Jefferson Chu, A0182590B
  10:../src/main.c ****  *  Optimization routine written in assembly language
  11:../src/main.c ****  *  Input parameters (signed integers):
  12:../src/main.c ****  *     xi : integer version of x
  13:../src/main.c ****  *        a, b, c: integer coefficients of f(x)
  14:../src/main.c ****  *        Output : returns solution x (signed integer)
  15:../src/main.c ****  *        iter: number of iterations
  16:../src/main.c ****  */
  17:../src/main.c **** extern int optimize(int xi, int a, int b, int c);
  18:../src/main.c **** 
  ...
  77              	.LCFI2:
  78              		.cfi_def_cfa 7, 80
  21:../src/main.c ****     int a=3, b=4, c=-3, xsoli;
  79              		.loc 1 21 0
 ...
 103 0042 FFF7FEFF 		bl	scanf
  27:../src/main.c **** 
  28:../src/main.c **** //  ARM ASM & Integer version
  29:../src/main.c ****     printf("ARM ASM & Integer version:\n");
 104              		.loc 1 29 0
 ...
 108 0050 FFF7FEFF 		bl	printf
  30:../src/main.c ****     xsoli = optimize((int) x * 100, a, 100 * b, &iter); //scaling of 100
 109              		.loc 1 30 0
 ...
 124 007e FB61     		str	r3, [r7, #28]
  31:../src/main.c ****     xsol = xsoli / 100.0;
 125              		.loc 1 31 0
 ...
 151 00c2 FFF7FEFF 		bl	printf
  33:../src/main.c ****     printf("Number of iterations : %d\n\n", iter);
 152              		.loc 1 33 0
 ...
 158 00d4 FFF7FEFF 		bl	printf
  34:../src/main.c **** 
  35:../src/main.c **** //  NOTE: You DO NOT need to modify the code below this line
  36:../src/main.c **** 
  37:../src/main.c **** //  C & Floating Point version
  38:../src/main.c ****   	printf("C & Floating point version:\n",x);
 159              		.loc 1 38 0
 ...
 207 0144 7B60     		str	r3, [r7, #4]	@ float
  46:../src/main.c **** 
  47:../src/main.c ****     	printf("x: %f, fp: %f, change: %f\n", x, fp, change);
 208              		.loc 1 47 0
 ...
 229 017c FFF7FEFF 		bl	printf
  48:../src/main.c ****     	if (x==xprev) break;
 230              		.loc 1 48 0
 ...
 243              	.L4:
  ...
  52:../src/main.c **** 	// This is for convenience to allow registers, variables and memory locations to be inspected at t
  53:../src/main.c **** 	volatile static int loop = 0;
...
DEFINED SYMBOLS
                            *ABS*:00000000 main.c
C:\Users\jeffe\AppData\Local\Temp\ccXJU9lC.s:19     .rodata:00000000 $d
C:\Users\jeffe\AppData\Local\Temp\ccXJU9lC.s:20     .rodata:00000000 .LC0
C:\Users\jeffe\AppData\Local\Temp\ccXJU9lC.s:24     .rodata:00000038 .LC1
C:\Users\jeffe\AppData\Local\Temp\ccXJU9lC.s:27     .rodata:0000003c .LC2
C:\Users\jeffe\AppData\Local\Temp\ccXJU9lC.s:34     .rodata:00000058 .LC3
C:\Users\jeffe\AppData\Local\Temp\ccXJU9lC.s:38     .rodata:00000068 .LC4
C:\Users\jeffe\AppData\Local\Temp\ccXJU9lC.s:41     .rodata:00000084 .LC5
C:\Users\jeffe\AppData\Local\Temp\ccXJU9lC.s:47     .rodata:000000a4 .LC6
C:\Users\jeffe\AppData\Local\Temp\ccXJU9lC.s:51     .text.main:00000000 $t
C:\Users\jeffe\AppData\Local\Temp\ccXJU9lC.s:56     .text.main:00000000 main
C:\Users\jeffe\AppData\Local\Temp\ccXJU9lC.s:263    .bss:00000000 loop.3827
C:\Users\jeffe\AppData\Local\Temp\ccXJU9lC.s:257    .text.main:000001b0 $d
C:\Users\jeffe\AppData\Local\Temp\ccXJU9lC.s:262    .bss:00000000 $d
